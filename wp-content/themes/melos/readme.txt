...
Melos WordPress Theme, Copyright 2020 Think Up Themes Ltd
...
The following opensource projects, graphics, fonts, API's or other files as listed have been used in developing this theme. Thanks to the author for the creative work they made. All creative works are licensed as being GPL or GPL compatible.
    ...
    [1.06] Item:        Custom made by Think Up Themes: transparent.png, placeholder_image.png, slide_demo2.png, slide_demo3.png, thinkupslider_bg_333_555.png
           Item URL:    /images/slideshow
           Licence:     CC0
           Licence URL: https://creativecommons.org/publicdomain/zero/1.0/

    [1.07] Item:        Image shown in slider on screenshot.png and slide_demo1.png.
           Item URL:    https://pxhere.com/en/photo/1592419
           Licence:     CC0
           Licence URL: https://creativecommons.org/publicdomain/zero/1.0/
...
= 1.4.2
- Updated: Recommended plugins added.

= 1.4.1
- Updated: Improved translation in theme toolbox.

= 1.4.0
- Updated: Theme toolbox moved to top level menu page.

= 1.3.12
- Updated: Improved underlining to show only for links within content.

= 1.3.11
- Updated: Tested up to version updated to ensure users know full compatibility with WordPress v5.7.

= 1.3.10
- Updated: Requires at least version updated to be 5.0.
- Updated: Tested up to version updated to ensure users know full compatibility with WordPress v5.7.

= 1.3.9
- Fixed:   Accessibility updated to ensure sub-menu navigation works correctly on mobile devices.

= 1.3.8
- Fixed:   Accessibility updated to ensure navigation works correctly on mobile devices.
...
- Updated: Toggle supported added to child menus in responsive menus.
...
- Fixed:   All textdomains for translations correctly use "melos".
- Fixed:   All variables set to null in migration script before executing.
- Fixed:   Migration check improved to ensure only runs if slides pre v1.3.0 are present.
